...
class TestService(unittest.TestCase):
    ...
    def test_TS11_comprobacion_sistema_operativo_maquina_dentro_alcance(self):
    ...
    # Revisar
    def test_TS15_obtencion_servicio_preinstalado(self):
        service_name = 'openssh.x86_64'
    ...
    #Revisar
    def test_TS16_obtencion_servicio_no_instalado(self):
        service_name = 'httpd.x86_64'
        ...
        self.assertNotIn(service_name, services)
        client.close()
    ...
    def test_TS22_obtencion_comandos_necesarios_por_sistema_operativo(self):
        suse_commands = ['opensuse', 'zypper list-updates', 'zypper list-updates', 'zypper up -y']
        self.assertEqual(service.get_commands_distro('suse'), suse_commands)
    
    def test_TS25_obtencion_maquina_sin_IP(self):
        result = service.get_ip_range('')
        self.assertEqual(result, [])
    
    def test_TS25_obtencion_maquina_erronea(self):
        result = service.get_ip_range('d.2111.332.1')
        self.assertEqual(result, [])
    
    def test_TS26_obtencion_maquina_IP(self):
        result = service.get_ip_range('192.168.56.110')
        self.assertEqual(result, ['192.168.56.110'])

    def test_TS27_obtencion_maquina_IP_lista_IPs_tipo1(self):
    ...
    def test_TS28_obtencion_maquina_rango_IPs_tipo2(self):
    ...
    def test_TS28_obtencion_maquina_rango_IPs_tipo3(self):
        result = service.get_ip_range('63.45.12.30 -63.45.12.34')
        self.assertEqual(result, ['63.45.12.30','63.45.12.31','63.45.12.32','63.45.12.33','63.45.12.34'])
    
    def test_TS29_obtencion_maquina_red_tipo1(self):
    ...
    def test_TS29_obtencion_maquina_red_tipo2(self):
        result = service.get_ip_range('192.168.56.0/30')
        self.assertEqual(result, ['192.168.56.1','192.168.56.2'])
    
    def test_TS30_instalacion_ficheros_en_maquina(self):
